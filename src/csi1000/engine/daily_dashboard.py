...
<b>选择偏差:</b>回测夏普 1.50 是 7 个主线选择点在同一段 2018-2026 上择优后的读数(h/种子选型、合奏构成、状态层参数均样本内选出),<b>保守预期夏普 1.0~1.2</b>(沿用 说明_v4.md 的折价口径;v5.1 选择点更多,不应比 v4 更乐观)。真正的样本外证据只有 2026-08 之后的实盘分段。<br>此面板为策略输出,非投资建议,自行决策与执行。
</div>
</body></html>"""
