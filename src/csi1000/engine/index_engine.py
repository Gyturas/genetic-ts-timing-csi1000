...
from csi1000.walkforward.engine import quarter_list

# ---------------- genetic-cta 照抄参数 ----------------
入库线, 残差线, 相关筛 = 0.015, 0.01, 0.9
TRAILING月 = 12
...
HOF参数 = {"size": 20, "min_train_ic": 0.02, "min_valid_ic": 0.02, "max_corr": 0.7}
单月最少对数 = 30
成本 = C.COST
